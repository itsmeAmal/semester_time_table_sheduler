...
public class userManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        //tblItems.getTableHeader().setDefaultRenderer(new DefaultTableRenderer(){
            //  {
                //    setOpaque(true);
                //  };
            tblUsers.getTableHeader().setOpaque(false);
            tblUsers.getTableHeader().setBackground(new Color(51, 153, 51));
            ...
            layout.setHorizontalGroup(
                ...
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(panel, javax.swing.GroupLayout.PREFERRED_SIZE, 633, Short.MAX_VALUE)
                    .addContainerGap())
            );
