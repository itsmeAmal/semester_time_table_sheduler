...
CREATE TABLE `delivery_plan` (
  ...
  `delivery_plan_lecture_3_hours` varchar(150) DEFAULT NULL,
  `delivery_plan_tutorial_2_hours` varchar(150) DEFAULT NULL,
  `delivery_plan_lab_2_hours_cl03` varchar(150) DEFAULT NULL,
