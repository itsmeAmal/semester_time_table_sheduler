 ...
 * @author Amal
 */
public class timeTableScheduler extends javax.swing.JFrame {
    ...
    private void addCourse() {
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(timeTableScheduler.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(timeTableScheduler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new timeTableScheduler().setVisible(true);
            }
        });
    }
