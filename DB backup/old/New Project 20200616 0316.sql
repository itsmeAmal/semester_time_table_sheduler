...
INSERT INTO `student` (`student_id`,`student_name`,`student_email_1`,`student_email_2`,`student_reg_no`,`student_contact_no`,`student_detail`,`student_status`,`student_batch_id`,`student_group_id`,`student_special_id`) VALUES 
 (1,'jdjgbsl','ljdjvhvldfkb','','ldkfjb;fb','.ldmvs;v','xnmcvbkcx',1,1,1,1),
 (2,'jdjgbsl','ljdjvhvldfkb','','ldkfjb;fb','.ldmvs;v','xnmcvbkcx',1,1,1,1),
 (3,'sdjjkdsvjb','dvfklbnl','','xmcb,','s;kg\'d;fh;','x,nbkdfb',1,1,1,1),
 (4,'bvjdbvf','jvbfjx','','x,cnbkjgbn','xcb,c','zjkjbvkfjvb',1,1,1,1);
